#!/usr/bin/env python3
"""
Create a beautifully formatted Birkat HaMazon following all requirements.
"""

import json

def create_formatted_birkat_hamazon():
    """Create fully formatted Birkat HaMazon."""
    
    data = {
        "name": "בִּרְכַּת הַמָּזוֹן",
        "hebrewName": "בִּרְכַּת הַמָּזוֹן",
        "category": "ברכות",
        "description": "בִּרְכַּת הַמָּזוֹן הַשְּׁלֵמָה לְאַחַר סְעוּדָה שֶׁיֵּשׁ בָּהּ פַּת - נוסח ספרד (מעוצב ומנוקד)",
        "paragraphs": [
            ...
            {
                "paragraph": 22,
                "text": "**_בבית אביו אומר:_**\n\n**הָרַחֲמָן**\n\nהוּא יְבָרֵךְ אֶת אָבִי מוֹרִי בַּעַל הַבַּיִת הַזֶּה,\n\nוְאֶת אִמִּי מוֹרָתִי בַּעֲלַת הַבַּיִת הַזֶּה.\n\nאוֹתָם וְאֶת בֵּיתָם וְאֶת זַרְעָם וְאֶת כָּל אֲשֶׁר לָהֶם,\n\nאוֹתָנוּ וְאֶת כָּל אֲשֶׁר לָנוּ,\n\nכְּמוֹ שֶׁנִּתְבָּרְכוּ אֲבוֹתֵינוּ אַבְרָהָם יִצְחָק וְיַעֲקֹב,\n\nבַּכֹּל מִכֹּל כֹּל,\n\nכֵּן יְבָרֵךְ אוֹתָנוּ כֻּלָּנוּ יַחַד בִּבְרָכָה שְׁלֵמָה.\n\nוְנֹאמַר:\n\nאָמֵן."
            },
            {
                "paragraph": 23,
                "text": "**_אם אוכל על שלחן אחרים יברך לבעל הבית:_**\n\nיְהִי רָצוֹן שֶׁלֹּא יֵבוֹשׁ וְלֹא יִכָּלֵם בַּעַל הַבַּיִת הַזֶּה,\n\nלֹא בָעוֹלָם הַזֶּה וְלֹא בָעוֹלָם הַבָּא,\n\nוְיַצְלִיחַ בְּכָל־נְכָסָיו,\n\nוְיִהְיוּ נְכָסָיו מוּצְלָחִים וּקְרוֹבִים לָעִיר.\n\nוְאַל־יִשְׁלוֹט שָׂטָן בְּמַעֲשֵׂה יָדָיו,\n\nוְאַל יִזְדָקֵּק לְפָנָיו שׁוּם דְּבַר חֵטְא וְהַרְהוֹר עָוֹן,\n\nמַעַתָּה וְעַד עוֹלָם."
            },
            {
                "paragraph": 24,
                "text": "בַּמָרוֹם יְלַמְּדוּ עֲלֵיהֶם וְעָלֵינוּ זְכוּת,\n\nשֶׁתְּהֵא לְמִשְׁמֶרֶת שָׁלוֹם.\n\nוְנִשָׂא בְרָכָה מֵאֵת יְיָ,\n\nוּצְדָקָה מֵאֱלֹהֵי יִשְׁעֵנוּ,\n\nוְנִמְצָא חֵן וְשֵׂכֶל טוֹב בְּעֵינֵי אֱלֹהִים וְאָדָם."
            },
            
            # HaRachaman for special days
            {
                "paragraph": 25,
                "heading": "🌟 הרחמן - לימים מיוחדים",
                "text": "**_בשבת:_**\n\n**הָרַחֲמָן**\n\nהוּא יַנְחִילֵנוּ יוֹם שֶׁכֻּלוֹ שַׁבָּת וּמְנוּחָה לְחַיֵּי הָעוֹלָמִים.\n\n**_ביום טוב:_**\n\n**הָרַחֲמָן**\n\nהוּא יַנְחִילֵנוּ יוֹם שֶׁכֻּלוֹי טוֹב.\n\n**_בראש חודש:_**\n\n**הָרַחֲמָן**\n\nהוּא יְחַדֵּשׁ עָלֵינוּ אֶת הָחֹדֶשׁ הַזֶּה לְטוֹבָה וְלִבְרָכָה.\n\n**_בראש השנה:_**\n\n**הָרַחֲמָן**\n\nהוּא יְחַדֵּשׁ עָלֵינוּ אֶת הַשָּׁנָה הַזֹּאת לְטוֹבָה וְלִבְרָכָה.\n\n**_בסוכות:_**\n\n**הָרַחֲמָן**\n\nהוּא יָקִים לָנוּ אֶת סֻכַּת דָּוִד הַנּוֹפֶלֶת."
            },
    ...
    # Write to file
    import pathlib
    file_path = pathlib.Path(__file__).parent.parent / "content/special/birkat_hamazon.json"
    with open(file_path, 'w', encoding='utf-8') as f:
        json.dump(data, f, ensure_ascii=False, indent=2)
    
    print(f"✅ Created beautifully formatted {file_path.name}")

if __name__ == "__main__":
    create_formatted_birkat_hamazon()
